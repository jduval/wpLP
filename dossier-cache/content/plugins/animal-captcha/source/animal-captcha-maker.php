...
</form> <button onclick="window.location.href=\''.($in_wp?'i../wp-admin/plugins.php?page=animal-captcha-maker&':'animal-captcha-maker.php?').'a=borrar&imagen='.$final_name_root.'\';" style="color:red;display:inline;">Delete</button><br />
...
(<a href="'.($in_wp?'../dossier-cache/content/plugins/animal-captcha/source/example.php':'example.php').'"><b>Try test</b></a>)
